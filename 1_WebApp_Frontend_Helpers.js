/*******************************************************************
 * Match Admin System: Web App - Frontend Helpers
 * 
 * Contains all the data-fetching and helper functions used by the
 * Web App. These functions interact with the spreadsheet to retrieve
 * settings, teams, fixtures, and other data needed by the frontend.
 *******************************************************************/
